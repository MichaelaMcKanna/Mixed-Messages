...
switch (author){
    case 'leafArray':
        collectiveWisdom.push(`Dr. Caroline Leaf would say:<br> "${wordsOfWisdom[author][index]}"<br>`);
    break
    case 'petersonArray':
        collectiveWisdom.push(` Jordon Peterson would say:<br> "${wordsOfWisdom[author][index]}"<br>`);
    break
    case 'doyleArray':
        collectiveWisdom.push(` Glennon Doyle would say:<br> "${wordsOfWisdom[author][index]}"<br>`);
    break
    default:
        collectiveWisdom.push('nothing');        
}
}
return `If you need a pick-me-up:<br> ${collectiveWisdom}`
}  */

// React.render(generateMessage, document.getElementById('message'));
